...
// Modified by: 2024 HB Craft

/// @dev The referenced UniswapOracle contracts are pragma solidity >=0.5.0 <0.8.0. Since Uniswap’s OracleLibrary is battle-tested with solidity 7, safe math checks are skipped.
...
contract UniswapOracle {
    ...
    function mulDiv(uint256 a, uint256 b, uint256 denominator) internal pure returns (uint256 result) {
        ...
        unchecked {
            ...
            // Always >= 1.
            int256 twosBefore = -int256(denominator) & int256(denominator);
            uint256 twos = uint256(twosBefore);
